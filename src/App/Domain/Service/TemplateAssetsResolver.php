...
class TemplateAssetsResolver extends CollectionResolver implements MimeResolverAwareInterface
{
    ...
    protected PageAssetService $pageAssetService;
    ...
    /**
     * {}
     * @return AssetCollection|AssetInterface|FileAsset|mixed|null
     * @throws Exception
     * @throws Exception
     */
     ...
     */
    public function resolveAbsolutePath(string $path): ?AssetInterface
    {
     ...
     */
    public function inAllowedPaths(string $name): bool
    {
     ...
     * @throws Exception
     */
    public function isGlobalAsset(string $name): bool
    {
     ...
     * @throws Exception
     */
    public function loadGlobalCollection(string $alias): void
    {
     ...
     * @throws Exception
     */
    public function generateCollection(array $paths, string $extension): array
    {
        $assets = [];
     ...
     * @param array $assets
     */
    public function addToCollections(string $alias, array $assets): void
    {
     ...
     * @throws Exception
     */
    public function isTemplateAsset(string $alias): bool
    {
     ...
     * @throws Exception
     */
    public function matchTemplateName(string $alias)
    {
     ...
     * @throws Exception
     */
    public function validTemplate(string $templatePath): bool
    {
     ...
     * @throws Exception
     */
    public function loadTemplateCollection(string $alias): void
    {
